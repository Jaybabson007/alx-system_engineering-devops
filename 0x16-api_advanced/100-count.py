#!/usr/bin/python3
'''A Python module containing different functions for working with the Reddit API.
'''
import requests


def sort_histogram(histogram={}):
    '''This function sorts and prints the given histogram.
    '''
...
def count_words(subreddit, word_list, histogram=[], n=0, after=None):
    '''This function counts the number of times each word in a given wordlist
